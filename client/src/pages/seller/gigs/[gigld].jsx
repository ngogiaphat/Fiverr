        ...
        <div className = "grid grid-cols-2 gap-11">
          <div>
            ...
            <input name = "title" value = {data.title} onChange = {handleChange}
              type = "text" id = "title" className = {inputClassName} placeholder = "e.g. I will do something I'm really good at" required
						/>
          </div>
          <div>
            ...
            <select id = "categories"
              ...
              name = "category" onChange = {handleChange}  value = {data.category}
            >
              {categories.map(({name}) => (
