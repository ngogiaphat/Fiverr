        ...
        <div className = "col-span-2 flex flex-col gap-3">
          ...
          <div className = "flex items-center gap-2">
            <div>
              {gigData.createdBy.profileImage ? (
                <Image src = {HOST + "/" + gigData.createdBy.profileImage} alt = "profile" height = {30} width = {30} className = "rounded-full"/>
              ) : (
          ...
          <div className = "flex flex-col gap-4">
            <div className = "max-h-[1000px] max-w-[1000px] overflow-hidden">
              <Image src = {HOST + "/uploads/" + currentImage} alt = "Gig" height = {1000} width = {1000} className = "hover:scale-110 transition-all duration-500"/>
            </div>
          ...
          <div className = "">
            ...
            <div className = "flex gap-4">
              <div>
                {gigData.createdBy.profileImage ? (
                  <Image src = {HOST + "/" + gigData.createdBy.profileImage} alt = "profile" height = {120} width = {120} className = "rounded-full"/>
                ) : (
                  <div className = "bg-purple-500 h-10 w-10 flex items-center justify-center rounded-full relative">
                    <span className = "text-xl text-white">
                      {gigData.createdBy.email[0].toUpperCase()};
